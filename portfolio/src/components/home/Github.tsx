...
import { Github as GithubIcon, Star, GitFork, Users } from "lucide-react";
    ...
    const fetchGithubData = async () => {
      try {
        ...
        const userResponse = await fetch(
          "https://api.github.com/users/Ebi-Tech"
        );
        ...
        const reposResponse = await fetch(
          "https://api.github.com/users/Ebi-Tech/repos?sort=stars&per_page=6"
        );
